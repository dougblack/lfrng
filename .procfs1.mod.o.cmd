cmd_/nethome/dblack7/proj1/random/procfs1.mod.o := gcc -Wp,-MD,/nethome/dblack7/proj1/random/.procfs1.mod.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.1.2/include -D__KERNEL__  -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -fno-delete-null-pointer-checks -O2  -mtune=generic -m64 -mno-red-zone -mcmodel=kernel -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -funit-at-a-time -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -fstack-protector -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(procfs1.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(procfs1)" -DMODULE -c -o /nethome/dblack7/proj1/random/procfs1.mod.o /nethome/dblack7/proj1/random/procfs1.mod.c

deps_/nethome/dblack7/proj1/random/procfs1.mod.o := \
  /nethome/dblack7/proj1/random/procfs1.mod.c \
...
/nethome/dblack7/proj1/random/procfs1.mod.o: $(deps_/nethome/dblack7/proj1/random/procfs1.mod.o)
